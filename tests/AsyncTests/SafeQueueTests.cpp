...
TEST_F(SafeQueueSuite, SafeQueue_one)
{
    ...
    first_done = std::async(std::launch::async,
                            [&first_q, &second_q, ready, &first_ready]() -> int
                            {
    ...
    second_done = std::async(std::launch::async,
                             [&first_q, &second_q, ready, &second_ready]() -> float
                             {
    ...
    third_done = std::async(std::launch::async,
                            [&first_q, ready, &third_ready]() -> int
                            {
...
TEST_F(SafeQueueSuite, SafeQueue_two)
{
    ...
    second_done = std::async(std::launch::async,
                             [&first_q, ready, &second_ready]() -> float
                             {
                                 second_ready.set_value();
                                 ready.wait();
...
TEST_F(SafeQueueSuite, SafeQueue_three)
{
    ...
    third_done = std::async(std::launch::async,
                            [&first_q, &second_q, ready, &third_ready]() -> int
                            {
                                third_ready.set_value();
                                ready.wait();
