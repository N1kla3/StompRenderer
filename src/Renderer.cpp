...
void Renderer::retrieveMaterialRenderState(
...
void Renderer::beginRenderPass(omp::RenderPass *inRenderPass,
...
void Renderer::endRenderPass(omp::RenderPass * /*inRenderPass*/,
                             VkCommandBuffer inCommandBuffer) {
...
void Renderer::prepareCommandBuffer(CommandBufferScope &bufferScope,
...
void Renderer::initializeScene() {
  ...
  auto lambda = [this](ImVec2 pos) { m_MousePickingData.push(pos); };
...
Renderer::addModelToScene(const std::string &inName,
